...
public class OrderUtils {
    ...
    private static final String model = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";

    /**
     * 订单号头
     * @return
     */
    private static String toalphabet(){
         String randomcode2 = "";
    ...
    public static void main(String[] args) {
        System.out.println(OrderUtils.toalphabet()+"-"+OrderUtils.getDateTime());
    }
