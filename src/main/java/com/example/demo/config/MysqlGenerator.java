...
public class MysqlGenerator {
    private static final String database = "zyj_demo";
    private static final String url = "jdbc:mysql://192.168.193.135:3306/" + database
    ...
    public static void main(String[] args) {
        //生成代码，多张表用逗号分隔
        generate("zyj","com.example.demo", "zyj_commom_attachment");
    }
